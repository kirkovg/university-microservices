...
public class StudentCriteria implements Serializable {
    ...
    private LongFilter scheduledClassId;
    ...
    public LongFilter getScheduledClassId() {
        return scheduledClassId;
    }

    public void setScheduledClassId(LongFilter scheduledClassId) {
    ...
    public String toString() {
        return "StudentCriteria{" +
                ...
                (scheduledClassId != null ? "scheduledClassId=" + scheduledClassId + ", " : "") +
            "}";
    }
