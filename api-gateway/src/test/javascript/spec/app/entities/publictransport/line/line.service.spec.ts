    ...
    describe('Line Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'publictransport/api/lines';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Line', () => {
                service.create(new Line(null)).subscribe(received => {
            ...
            it('should update a Line', () => {
                service.update(new Line(123)).subscribe(received => {
