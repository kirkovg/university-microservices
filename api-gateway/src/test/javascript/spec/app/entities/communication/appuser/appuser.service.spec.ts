    ...
    describe('Appuser Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'communication/api/appusers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Appuser', () => {
                service.create(new Appuser(null)).subscribe(received => {
            ...
            it('should update a Appuser', () => {
                service.update(new Appuser(123)).subscribe(received => {
