...
import { ScheduledclassComponent } from 'app/entities/officehours/scheduledclass/scheduledclass.component';
...
describe('Component Tests', () => {
    describe('Scheduledclass Management Component', () => {
        let comp: ScheduledclassComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ScheduledclassComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.scheduledclasses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
