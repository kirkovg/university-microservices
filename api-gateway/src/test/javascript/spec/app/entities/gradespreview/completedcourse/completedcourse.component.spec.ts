...
import { CompletedcourseComponent } from 'app/entities/gradespreview/completedcourse/completedcourse.component';
...
describe('Component Tests', () => {
    describe('Completedcourse Management Component', () => {
        let comp: CompletedcourseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CompletedcourseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.completedcourses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
