...
import { ArticleUpdateComponent } from 'app/entities/news/article/article-update.component';
import { ArticleService } from 'app/entities/news/article/article.service';
import { Article } from 'app/shared/model/news/article.model';
