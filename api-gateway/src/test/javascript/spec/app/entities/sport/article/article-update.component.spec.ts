...
import { ArticleUpdateComponent } from 'app/entities/sport/article/article-update.component';
import { ArticleService } from 'app/entities/sport/article/article.service';
import { Article } from 'app/shared/model/sport/article.model';
