...
import { TaskDeleteDialogComponent } from 'app/entities/assignedtask/task/task-delete-dialog.component';
import { TaskService } from 'app/entities/assignedtask/task/task.service';
