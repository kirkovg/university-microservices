...
import mk.ukim.finki.directory.web.rest.errors.BadRequestAlertException;
import mk.ukim.finki.directory.web.rest.util.HeaderUtil;
import mk.ukim.finki.directory.web.rest.util.PaginationUtil;
...
public class ContactResource {
    ...
    private static final String ENTITY_NAME = "directoryContact";
