...
public class IngredientCriteria implements Serializable {
    ...
    private BigDecimalFilter weightInGrams;
    ...
    public BigDecimalFilter getWeightInGrams() {
        return weightInGrams;
    }

    public void setWeightInGrams(BigDecimalFilter weightInGrams) {
    ...
    public String toString() {
        return "IngredientCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
                (weightInGrams != null ? "weightInGrams=" + weightInGrams + ", " : "") +
            "}";
    }
