package mk.ukim.finki.multimedia.web.rest;

import mk.ukim.finki.multimedia.MultimediaApp;

import mk.ukim.finki.multimedia.domain.File;
import mk.ukim.finki.multimedia.repository.FileRepository;
import mk.ukim.finki.multimedia.service.FileService;
import mk.ukim.finki.multimedia.web.rest.errors.ExceptionTranslator;
...
import static mk.ukim.finki.multimedia.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = MultimediaApp.class)
