package mk.ukim.finki.photo.web.rest;

import mk.ukim.finki.photo.PhotoApp;
...
import mk.ukim.finki.photo.web.rest.errors.ExceptionTranslator;
...
import static mk.ukim.finki.photo.web.rest.TestUtil.createFormattingConversionService;
...
public class PhotoResourceIntTest {
    ...
    public void createPhoto() throws Exception {
        ...
        assertThat(testPhoto.getPicture()).isEqualTo(DEFAULT_PICTURE);
        assertThat(testPhoto.getPictureContentType()).isEqualTo(DEFAULT_PICTURE_CONTENT_TYPE);
    }
    ...
    public void updatePhoto() throws Exception {
        ...
        assertThat(testPhoto.getPicture()).isEqualTo(UPDATED_PICTURE);
        assertThat(testPhoto.getPictureContentType()).isEqualTo(UPDATED_PICTURE_CONTENT_TYPE);
    }
