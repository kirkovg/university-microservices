...
import mk.ukim.finki.photo.web.rest.errors.BadRequestAlertException;
import mk.ukim.finki.photo.web.rest.util.HeaderUtil;
import mk.ukim.finki.photo.web.rest.util.PaginationUtil;
...
public class PhotoResource {
    ...
    private static final String ENTITY_NAME = "photoPhoto";
