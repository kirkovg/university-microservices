...
import mk.ukim.finki.career.web.rest.errors.BadRequestAlertException;
import mk.ukim.finki.career.web.rest.util.HeaderUtil;
import mk.ukim.finki.career.web.rest.util.PaginationUtil;
...
public class PostResource {
    ...
    private static final String ENTITY_NAME = "careerPost";
