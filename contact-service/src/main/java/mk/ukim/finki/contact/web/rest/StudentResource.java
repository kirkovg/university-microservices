...
import mk.ukim.finki.contact.web.rest.errors.BadRequestAlertException;
import mk.ukim.finki.contact.web.rest.util.HeaderUtil;
import mk.ukim.finki.contact.web.rest.util.PaginationUtil;
...
public class StudentResource {
    ...
    private static final String ENTITY_NAME = "contactStudent";
