...
import mk.ukim.finki.assignedtask.service.StudentService;
...
import mk.ukim.finki.assignedtask.service.StudentQueryService;
...
public class StudentResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllStudentsByTaskIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the studentList where task equals to taskId
        defaultStudentShouldBeFound("taskId.equals=" + taskId);

        // Get all the studentList where task equals to taskId + 1
        defaultStudentShouldNotBeFound("taskId.equals=" + (taskId + 1));
    }
