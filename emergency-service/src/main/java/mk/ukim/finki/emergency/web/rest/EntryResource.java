...
import mk.ukim.finki.emergency.web.rest.errors.BadRequestAlertException;
import mk.ukim.finki.emergency.web.rest.util.HeaderUtil;
import mk.ukim.finki.emergency.web.rest.util.PaginationUtil;
...
public class EntryResource {
    ...
    private static final String ENTITY_NAME = "emergencyEntry";
    ...
    @GetMapping("/entries")
    @Timed
    public ResponseEntity<List<Entry>> getAllEntries(EntryCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Entries by criteria: {}", criteria);
        Page<Entry> page = entryQueryService.findByCriteria(criteria, pageable);
